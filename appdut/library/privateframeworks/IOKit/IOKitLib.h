...
/*! @function IORegistryEntryGetName
    @abstract Returns a C-string name stronged to a registry entry.
...
/*! @function IORegistryEntryGetNameInPlane
    @abstract Returns a C-string name stronged to a registry entry, in a specified plane.
...
/*! @function IORegistryEntryGetLocationInPlane
    @abstract Returns a C-string location stronged to a registry entry, in a specified plane.
