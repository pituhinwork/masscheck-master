...
@property (strong, nonatomic, readwrite) NSUInteger majorClass;
@property (strong, nonatomic, readwrite) NSUInteger minorClass;
@property (strong, nonatomic, readwrite) NSInteger type;
@property (strong, nonatomic, readwrite) BOOL supportsBatteryLevel;
